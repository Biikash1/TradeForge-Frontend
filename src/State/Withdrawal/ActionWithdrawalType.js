...
export const WITHDRAWAL_PROCED_REQUEST = "WITHDRAWAL_PROCED_REQUEST";
export const WITHDRAWAL_PROCED_SUCCESS = "WITHDRAWAL_PROCED_SUCCESS";
export const WITHDRAWAL_PROCED_FAILURE = "WITHDRAWAL_PROCED_FAILURE";
